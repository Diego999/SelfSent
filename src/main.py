...
def load_parameters(parameters_filepath=os.path.join('.', 'parameters.ini'), verbose=True):
    ...
    for k, v in parameters.items():
        ...
        if k in ['seed', 'train_size', 'valid_size', 'test_size', 'remap_to_unk_count_threshold', 'token_embedding_dimension', 'number_of_cpu_threads', 'number_of_gpus', 'lstm_hidden_state_dimension', 'batch_size', 'da', 'r']:
            parameters[k] = int(v)
        elif k in ['']:
